...
package de.fhws.fiw.fds.suttondemo.api.states;

import de.fhws.fiw.fds.sutton.server.api.states.AbstractState;
import de.fhws.fiw.fds.sutton.server.api.states.get.AbstractGetDispatcherState;
import de.fhws.fiw.fds.suttondemo.api.states.persons.PersonRelTypes;
import de.fhws.fiw.fds.suttondemo.api.states.persons.PersonUri;
...
public class DispatcherState extends AbstractGetDispatcherState
{
	...
	@Override protected void defineTransitionLinks( )
	{
		addLink( PersonUri.REL_PATH,
			PersonRelTypes.CREATE_PERSON, MediaType.APPLICATION_JSON );
		addLink( PersonUri.REL_PATH,
