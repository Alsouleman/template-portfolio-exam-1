...
public class PagingBehaviorUsingOffsetSize<T extends AbstractModel>
	implements PagingBehavior<T>
{
	...
	@Override
	public void addPageHeader( final PagingContext pagingContext,
		final CollectionModelResult<?> result )
	{
		// not implemented
	}
